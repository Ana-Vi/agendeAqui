...
SECRET_KEY = '-ayh$p=cljm@=4+660ugsdy&1#fzx^2)1l6a2q99*(22o^&*x$'
...
WSGI_APPLICATION = 'agendeAqui.wsgi.application'
...
STATIC_URL = '/static/'
#colocar para aceitar o templates na raiz
STATICFILES_DIRS = [
